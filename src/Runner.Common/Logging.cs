...
namespace GitHub.Runner.Common
{
    ...
    public class StoragePagingLogger : RunnerService, IPagingLogger
    {
        ...
        public StoragePagingLogger(string writeBase, string stepName, int order, Guid jobId)
        {
        ...
        public void Setup(Guid timelineId, Guid timelineRecordId)
        {
            ...
            var directory = Path.Combine(_writeBase, _timelineId.ToString(), _jobId.ToString());
        ...
        {
            var baseName = $"{_order}_{_stepName}";
            return $"{readBase.TrimEnd('/')}/{_timelineId}/{_jobId}/{baseName}.log";
        }
